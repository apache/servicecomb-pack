...
import org.apache.servicecomb.pack.alpha.fsm.channel.*;
...
public class FsmAutoConfiguration {
  ...
  public ActorEventChannel kafkaEventChannel(ActorEventSink actorEventSink, MetricsService metricsService, @Lazy KafkaMessagePublisher kafkaMessagePublisher){
